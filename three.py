...
if uploaded_file is not None:
    ...
    with st.spinner('🔍 Analyzing X-ray image...'):
        ...
        # GradCAM - Generate at original resolution
        cam = gradcam(CategoricalScore([np.argmax(pred)]), preprocess_image(img_resized), penultimate_layer=-1)
        heatmap = cam[0]
        
        # Resize heatmap to match image dimensions with CUBIC interpolation for better quality
        ...
        heatmap_2d = cv2.bilateralFilter(heatmap_2d, 9, 75, 75)
